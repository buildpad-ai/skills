...
- `.kiro/specs/{feature}/research.md` (if exists, contains gap analysis from `/buildpad-validate-gap`)
...
- **Suggested Action**: "Run `/buildpad-spec-design {feature} -y` to auto-approve requirements and proceed"

**Missing Requirements**:
- **Stop Execution**: Requirements document must exist
- **User Message**: "No requirements.md found at `.kiro/specs/{feature}/requirements.md`"
- **Suggested Action**: "Run `/buildpad-spec-requirements {feature}` to generate requirements first"
...
- **Suggested Action**: Clarify or fix `requirements.md`, then re-run `/buildpad-spec-design {feature}`

### Next Phase: Task Generation

**If Design Approved**:
- **Optional**: Run `/buildpad-validate-design {feature}` for interactive quality review
- Run `/buildpad-spec-tasks {feature}` to generate implementation tasks
- Or `/buildpad-spec-tasks {feature} -y` to auto-approve and proceed directly

**If Modifications Needed**:
- Provide feedback and re-run `/buildpad-spec-design {feature}`
