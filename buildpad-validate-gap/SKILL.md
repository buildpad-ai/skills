...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/buildpad-spec-requirements {feature}` first to generate requirements"
...
- Run `/buildpad-spec-design {feature}` to create technical design document
- Or `/buildpad-spec-design {feature} -y` to auto-approve requirements and proceed directly
