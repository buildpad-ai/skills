...
- For Bootstrap mode: Read templates from `.kiro/settings/templates/steering/` (if that directory does not exist, first copy this skill's bundled `settings-templates/steering/` directory to `.kiro/settings/templates/steering/`)
