...
# buildpad-validate-design Skill
...
### Error Scenarios
- **Missing Design**: If design.md doesn't exist, stop with message: "Run `/buildpad-spec-design {feature}` first to generate design document"
...
- Re-run `/buildpad-spec-design {feature}` with improvements
- Re-validate with `/buildpad-validate-design {feature}`
