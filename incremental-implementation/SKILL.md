...
> **Parallel slices:** independent slices can be built by parallel subagents (see `subagent-delegation`), but integration and the build/test/verify loop stay on the main thread.
